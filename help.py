...
COMMAND_GROUPS = {
    ...
    "AI 기능": {
        "emoji": "💫",
        "content": "이 기능은 아직까지 완벽히 구현되지 않아 **베타 서비스**로 운영중이에요.\n아래의 기능을 사용 시 불안정할 수 있어요.\n### 설탕이와 대화하기\n저와 대화하실 수 있어요.\n<@943838140316155974>, \"설탕아\", \"시냅아\" 로 부르실 수 있어요.\n-# **메시지에 __답장__을 해 대화를 이어나가거나 저를 다시 불러 대화를 새로 시작할 수 있어요.**\n### 대화 요약하기\n</대화요약:1529030557105651753> - 최근 진행된 대화의 요약을 확인해요.\n> </대화요약:1529030557105651753> [분석 개수: 10개 / 20개 / 30개]\n-# 다른 궁긍한 것이 있나요? 아래의 선택 상자에서 골라보세요!"
    },
    "TTS (Text-to-Speech)": {
        "emoji": "🔊",
    ...
    "기타 기능": {
        "emoji": "🔧",
        "content": "</환율:1538479957918097408> - 환율을 알 수 있어요.\n\n</이벤트:1504866750057943135> - Giveaways를 주최할 수 있어요.\n\n</추첨:1504866750477500416> - 대상을 지정하여 랜덤 추첨을 할 수 있어요.\n> </추첨:1504866750477500416> [승리 인원] [이름: 쉼표, 띄어쓰기, 슬래시 등으로 구분 가능]\n-# 다른 궁긍한 것이 있나요? 아래의 선택 상자에서 골라보세요!"
    },
    "레벨": {
        "emoji": "⭐",
        "content": "레벨 기능은 **봇이 초대된 순간**부터 메시지 수 측정과 EXP 획득을 시작해요.\n\n</레벨:1539276243667656828> - 나의 현재 레벨과 EXP를 확인할 수 있어요.\n> 일일 채팅량, 주간 채팅량, 봇이 초대된 후 지금까지의 누적 채팅량을 확인할 수 있어요.\n\n</레벨알림:1539286695701127290> - 레벨업 시 DM으로 알림을 받을지 말지 선택할 수 있어요.\n-# 기본 설정은 **'꺼짐'** 으로 되어 있어요.\n\n</순위:1539651181373300846> - 서버 리더보드를 확인할 수 있어요.\n> 1위부터 10위까지 표시되고, 본인의 등수를 표시해요.\n-# 다른 궁긍한 것이 있나요? 아래의 선택 상자에서 골라보세요!"
    }
}
...
async def help_slash(interaction: discord.Interaction):
    content = (
        ...
        " 관리 기능, 챗봇 기능을 써보시지 않으실래요?\n모든 기능은 [여기](<https://sfx05.xyz/commands>)에서 볼수 있어요.\n\n도움이 필요하세요?"
